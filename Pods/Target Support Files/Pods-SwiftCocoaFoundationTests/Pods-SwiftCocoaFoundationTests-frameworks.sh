...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/Nimble/Nimble.framework"
  install_dsym "${PODS_ROOT}/Nimble/Nimble.framework.dSYM"
  install_framework "${PODS_ROOT}/Quick/Quick.framework"
  install_dsym "${PODS_ROOT}/Quick/Quick.framework.dSYM"
fi
